...
const Header = () => {
  ...
  return (
    <HeaderStyle>
        ...
        <Col xs={6}>
          <div className="header-user">
            <div className="header-user__info">
              <div className="header-user__info-name">Hi, Recruiter</div>
              <div className="header-user__info-employee">
                {/* {dataProfile.name} */}
              </div>
            </div>
            <div className="header-user__image" onClick={showModal}>
              <img className="img-user" src={userDefault} alt="default user" />
            </div>
          </div>
        </Col>
      </Row>
      ...
      />
      <ChangePassword isOpen={isChangePass} onClose={closeChangePassword} />
      <EmailVerification isOpen={isVerifyEmail} onClose={closeCVerifyEmail} />
    </HeaderStyle>
  );
};
