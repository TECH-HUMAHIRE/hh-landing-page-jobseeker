...
import CandidateDetailStyle from '../../../feature/auth/MyResume/partial/ProfileInformation/profile-information.style';
...
import Experience from '../../../feature/auth/MyResume/partial/ProfileInformation/Experience';
          ...
          <div className="modal-header__right">
            ...
            <div className="modal-header__info">
              ...
              <div className="modal-header__info-location">
                {data?.jobseeker.sub_district.district.city.name},{' '}
                {
                  data?.jobseeker.sub_district.district.city.province.country
                    .name
                }
              </div>
            </div>
        ...
        <Row>
          ...
          <Col sm={6}>
            <div className="referred-information__card">
              ...
              <div>
                <div className="referred-information__label">Education</div>
                <div className="referred-information__value">
          ...
          <Col sm={6}>
            <div className="referred-information__card">
              ...
              <div>
                ...
                <div className="referred-information__value">
                  {formatMoney(data?.jobseeker.expected_sallary)} (
        ...
        <Row>
          <Col md={6}>
            <div className="referred-information__card">
              ...
              <div>
                <div className="referred-information__label">Phone</div>
                <div className="referred-information__value">
          ...
          <Col md={6}>
            <div className="referred-information__card">
              ...
              <div>
                <div className="referred-information__label">Email</div>
                <div className="referred-information__value">
        ...
        <div style={{ marginBottom: 25 }}>
          <div className="referred-information__contact">
            <div className="referred-information__user border">
                ...
                <div>
                  ...
                  <div>
                    <span className="referred-information__rating">
                      <StarFilled style={{ color: '#F57F17' }} /> 4.8 (9
                      Reviews)
                    </span>
                  </div>
                </div>
              ...
              <div className="referred-information__chat ">
                <ChattingIcon color={color.employee.primary} /> Chat
              </div>
            </div>
          ...
          <Row>
            <Col md={12}>
              ...
              way. But we are two worlds apart can't reach to your heart when
              you say that I want it that way.
            </Col>
          </Row>
        </div>
        <Row>
