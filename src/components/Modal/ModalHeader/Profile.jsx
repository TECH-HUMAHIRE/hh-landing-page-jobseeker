  ...
  return (
    ...
    >
      <div className="modal-body">
        <Row>
          ...
          <Col md={6}>
            ...
            >
              <Input type={'text'} size="large" placeholder="Job Role" />
            </Form.Item>
          </Col>
          <Col md={6}>
            <Form.Item
            ...
            >
              <Input type={'text'} size="large" placeholder="Departement" />
            </Form.Item>
          </Col>
        </Row>
      </div>
          ...
          <Col md={12}>
            ...
            >
              <Radio.Group name="language">
                <Row>
                  <Col md={6}>
                    <Radio className="radio-label" value={'English'}>
                      English
                    </Radio>
                  </Col>
                  <Col md={6}>
                    <Radio className="radio-label" value={'Indonesia'}>
                      Indonesia
                    </Radio>
                  </Col>
                </Row>
      ...
      <div className="modal-body">
        ...
        <Row>
          <Col md={6}>
            <a href="mailto:customer.service@humahire.com" className="mailto">
              <MessegerIcon /> customer.service@humahire.com
            </a>
          </Col>
          <Col md={6}>
            <Button icon={<ChatMessegerIcon />} block color="outline-primary">
