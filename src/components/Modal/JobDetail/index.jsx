  ...
  return (
    ...
    >
        ...
        <div className="job-header">
          ...
          <div className="job-info job-header__info">
            <div className="job-header__company">
              <img src={defaultImage} alt="" className="job-header__logo" />
              <div>
      ...
      <div className="job-info">
        ...
        <Row>
          <Col sm={6}>
            <div className="job-information__label">Specialization</div>
          ...
          <Col sm={6}>
            <div className="job-information__label">Employment type</div>
            <div className="job-information__card">
              <div className="job-information__icon">
                <img src={BagIcon} alt="" />
              </div>
          ...
          <Col sm={6}>
            <div className="job-information__label">Type of work</div>
            <div className="job-information__card">
              <div className="job-information__icon">
          ...
          <Col sm={6}>
            <div className="job-information__label">Min Education</div>
            <div className="job-information__card">
              <div className="job-information__icon">
        ...
        <Row>
          <Col xl={12}>
            ...
            <div className="job-overview__desc">
              ...
              <div>
                {`${
                  data?.sub_district?.district?.city?.province?.country?.name
                    ? data?.sub_district?.district?.city?.province?.country
                        ?.name + ', '
                    : ''
                }`}
                {`${
                  data?.sub_district?.district?.city?.province?.name
                    ? data?.sub_district?.district?.city?.province?.name + ', '
                    : ''
                }`}
                {`${
