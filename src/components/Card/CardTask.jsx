  ...
  return (
        ...
        <div className="card-header">
          <div className="card-header__right">
            ...
            <div className="card-header__info">
              <div className="card-header__info-name">{job?.title}</div>
    ...
    >
      ...
      <div className="card-status">
        ...
        >
          Posted {moment(job.updated_at).format('DD-MM-YYYY')} • Expired:
      ...
      <Link
        ...
        disabled={job?.count_invitation_status?.referred_candidates < 1}
      >
        <div className="card-info">
          <b>{job?.count_invitation_status?.referred_candidates}</b> Referred
          Candidates
        </div>
      </Link>
      <Link
        to={`/shortlisted-candidates?id=${job.id}`}
        disabled={job.count_invitation_status.shortlisted_candidates < 1}
      >
        <div className="card-info">
      ...
      >
        <div className="card-info last">
          <b>{job.count_invitation_status.interview_candidates}</b> Interview
          Candidates
        </div>
      </Link>
    </CardJobStyle>
