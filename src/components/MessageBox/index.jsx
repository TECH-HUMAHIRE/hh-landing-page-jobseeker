    ...
    <MessageBoxStyle>
      <div className="message-header">
        <div className="message-header__top">
          <Avatar src={dummyUser} className="message-header__avatar" />
          <div className="message-header__right">
            ...
            <div className="message-tabs__chat">
              ...
              voluptatum neque ad, ipsam laboriosam iste repellendus aliquid
              nemo exercitationem provident eum praesentium magnam et quod
              eveniet ex libero! Distinctio, ad.
            </div>
          </div>
        </div>
      ...
      <div className="message-body">
        <img src={Background} alt="" className="message-body__background" />
        <div className="message-body__chat">
          <div className="message-body__conversation">
            {' '}
            <LockOutlined /> This conversation is confidential and cannot be
            seen by other users.
          </div>
          {/* CHAT MESSAGE */}
        </div>
      ...
      <Form form={form} onFinish={hanldeSendMessage}>
        <div className="message-bottom">
          ...
          <Form.Item name="text_chat" className="form-input">
            <Input type={'text'} size="large" width={'max-context'} />
          </Form.Item>
